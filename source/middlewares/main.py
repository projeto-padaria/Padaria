...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def cadastroFuncionario(self):
        ...
        valores = [self.cpf,self.nome,self.sobrenome,self.senha,self.cargo,self.salario,self.telefone,self.rua,self.numero,self.bairro,self.cidade,self.uf,self.cep]
        for indice,valor in enumerate(valores):
            if valor == '':
                valores.pop(indice)
                valores.insert(indice,'NULL')
        try:
            self.db.Login()
            self.db.insertTableFun(self.cpf,self.nome,self.sobrenome,self.senha,self.cargo,self.salario,self.telefone,self.rua,self.numero,self.bairro,self.cidade,self.uf,self.cep)
