...
class Ui_MainWindowLogin(object):
    def setupUi(self, MainWindowLogin):
        ...
        MainWindowLogin.resize(350, 320)
        MainWindowLogin.setMinimumSize(QSize(350, 320))
        MainWindowLogin.setMaximumSize(QSize(350, 320))
        MainWindowLogin.setStyleSheet(u"background-color: rgb(0, 0, 0);")
        self.centralwidget = QWidget(MainWindowLogin)
        self.centralwidget.setObjectName(u"centralwidget")
        self.centralwidget.setMinimumSize(QSize(350, 300))
        self.centralwidget.setMaximumSize(QSize(350, 300))
